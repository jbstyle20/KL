  ...
  "inbounds": [
      ...
      "settings": {
        ...
        "fallbacks": [
          ...
          {
            "path": "/joy-vlesswsntls", # // VLESS NONE
            "dest": 1301,
            "xver": 1
          },
          {
            "path": "/joy-vmesswsntls", # // VMESS NONE
            "dest": 1302,
            "xver": 1
          },
          {
             "path": "/joy-trojanwsntls", # // TROJAN NONE
            "dest": 1303,
            "xver": 1
          }
        ]
...
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/KL/main/cert.sh"
